...
onMounted(() => {
    isotopeInstance = new IsoTope(portfolioGrid.value, {
        itemSelector: ".all",
        layoutMode: "fitRows",
    });
});
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner_content">
                            ...
                            <h1 class="text-uppercase">I am rh sadik</h1>
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="main_title text-left">
                        ...
                        <p>
                            ...
                            itself together created after sea is in beast
                            beginning signs open god you're gathering whose
                            gathered cattle let. Creature whales fruit unto meat
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo1.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo2.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo3.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo4.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo5.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo6.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo7.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo8.png"
                                        alt=""
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="single-brand-item d-table">
                                <div class="d-table-cell text-center">
                                    <img
                                        src="../../assets/img/brands/logo9.png"
                                        alt=""
                                    />
                                </div>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="main_title">
                        ...
                        <p>
                            Is give may shall likeness made yielding spirit a
                            itself togeth created after sea <br />
            ...
            <div class="row feature_inner">
                <div class="col-lg-3 col-md-6">
                    <div class="feature_item">
                        ...
                        <h4>Wp developing</h4>
                        <p>
                            Creeping for female light years that lesser can't
                            evening heaven isn't bearing tree
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
    ...
    <section class="portfolio_area" id="portfolio">
        <div class="container">
            ...
            <div class="filters portfolio-filter">
                <ul>
                    <li @click="filterItems('*')">all</li>
                    <li @click="filterItems('.popular')">popular</li>
                    <li @click="filterItems('.latest')">latest</li>
                    <li @click="filterItems('.following')">following</li>
                    <li @click="filterItems('.upcoming')">upcoming</li>
                </ul>
            </div>

            <div class="filters-content">
                <div
                    class="row portfolio-grid justify-content-center"
                    ref="portfolioGrid"
                >
                    <div class="col-lg-4 col-md-6 all latest">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <a
                                    href="../../assets/img/portfolio/p1.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                    ...
                    <div class="col-lg-4 col-md-6 all popular">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p2.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all latest">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p3.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all popular">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p4.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p5.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p6.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p7.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all following">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p8.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
                    ...
                    <div class="col-lg-4 col-md-6 all upcoming">
                        <div class="portfolio_box">
                            <div class="single_portfolio">
                                ...
                                <div class="overlay"></div>
                                <a
                                    href="../../assets/img/portfolio/p9.jpg"
                                    class="img-gal"
                                >
                                    <div class="icon">
                                        <span class="lnr lnr-cross"></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <div class="main_title">
                        ...
                        <p>
                            Is give may shall likeness made yielding spirit a
                            itself togeth created after sea is in beast <br />
                ...
                <div class="testi_slider owl-carousel">
                    <div class="testi_item">
                        <div class="row">
                            <div class="col-lg-4">
                                <img
                                    src="../../assets/img/testimonials/t1.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="col-lg-8">
                                <div class="testi_text">
                                    <h4>Elite Martin</h4>
                                    <p>
                                        Him, made can't called over won't there
                    ...
                    <div class="testi_item">
                        <div class="row">
                            <div class="col-lg-4">
                                <img
                                    src="../../assets/img/testimonials/t2.jpg"
                                    alt=""
                                />
                            </div>
                            <div class="col-lg-8">
