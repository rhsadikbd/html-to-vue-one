      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="categories_post">
            <img
              src="../../assets/img/blog/cat-post/cat-post-3.jpg"
              alt="post"
            />
        ...
        <div class="col-lg-4">
          <div class="categories_post">
            <img
              src="../../assets/img/blog/cat-post/cat-post-2.jpg"
              alt="post"
            />
            <div class="categories_details">
              <div class="categories_text">
        ...
        <div class="col-lg-4">
          <div class="categories_post">
            <img
              src="../../assets/img/blog/cat-post/cat-post-1.jpg"
              alt="post"
            />
            <div class="categories_details">
              <div class="categories_text">
          ...
          <div class="blog_left_sidebar">
            <article class="row blog_item">
              ...
              <div class="col-md-9">
                <div class="blog_post">
                  <img
                    src="../../assets/img/blog/main-blog/m-blog-1.jpg"
                    alt=""
                  />
                  <div class="blog_details">
                    ...
                    <a href="single-blog.html" class="primary_btn"
            ...
            <article class="row blog_item">
              ...
              <div class="col-md-9">
                <div class="blog_post">
                  <img
                    src="../../assets/img/blog/main-blog/m-blog-2.jpg"
                    alt=""
                  />
                  <div class="blog_details">
                    <a href="single-blog.html"
            ...
            <article class="row blog_item">
              ...
              <div class="col-md-9">
                <div class="blog_post">
                  <img
                    src="../../assets/img/blog/main-blog/m-blog-3.jpg"
                    alt=""
                  />
                  <div class="blog_details">
                    <a href="single-blog.html"
            ...
            <article class="row blog_item">
              ...
              <div class="col-md-9">
                <div class="blog_post">
                  <img
                    src="../../assets/img/blog/main-blog/m-blog-4.jpg"
                    alt=""
                  />
                  <div class="blog_details">
            ...
            <article class="row blog_item">
              ...
              <div class="col-md-9">
                <div class="blog_post">
                  <img
                    src="../../assets/img/blog/main-blog/m-blog-5.jpg"
                    alt=""
                  />
                  <div class="blog_details">
          ...
          <div class="blog_right_sidebar">
            ...
            <aside class="single_sidebar_widget popular_post_widget">
              ...
              <div class="media post_item">
                <img
                  src="../../assets/img/blog/popular-post/post1.jpg"
                  alt="post"
                />
              ...
              <div class="media post_item">
                <img
                  src="../../assets/img/blog/popular-post/post2.jpg"
                  alt="post"
                />
                <div class="media-body">
              ...
              <div class="media post_item">
                <img
                  src="../../assets/img/blog/popular-post/post3.jpg"
                  alt="post"
                />
                <div class="media-body">
              ...
              <div class="media post_item">
                <img
                  src="../../assets/img/blog/popular-post/post4.jpg"
                  alt="post"
                />
                <div class="media-body">
